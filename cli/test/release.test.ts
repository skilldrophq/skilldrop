...
`
  ...
  expect(tarballUrl("1.2.3")).toBe("https://registry.npmjs.org/@skilldrop/cli/-/cli-1.2.3.tgz")
  expect(rendered).toContain('url "https://registry.npmjs.org/@skilldrop/cli/-/cli-1.2.3.tgz"')
